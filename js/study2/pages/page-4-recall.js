...
import { radioGroup, textArea, likert, divider } from "../../form-helpers.js";
...
export default {
  ...
  mount(container, state, ctx) {
    ...
    if (state.podcastTopic === "ne") {
      fields.recall = [
        radioGroup(container, "<strong>1.</strong> Which of the following is <mark>NOT</mark> a step in the nuclear fission chain reaction described in the podcast?", [
        ...
        radioGroup(container, "<strong>2.</strong> Why is nuclear fuel considered more attractive than burning fossil fuels according to the hosts?", [
        ...
        radioGroup(container, "<strong>3.</strong> Which of the following is <mark>NOT</mark> a characteristic of commercial nuclear fuel pellets?", [
        ...
        radioGroup(container, "<strong>4.</strong> How did the hosts characterize the scale of a reactor meltdown and a nuclear explosion?", [
        ...
        radioGroup(container, "<strong>5.</strong> Which of the following is <mark>NOT</mark> true regarding weapons-grade uranium compared to reactor fuel?", [
        ...
        radioGroup(container, "<strong>6.</strong> What is the primary safety function of control rods made from materials like silver, indium, or boron?", [
        ...
        radioGroup(container, "<strong>7.</strong> What is the primary safety function of the steel-reinforced containment building in the 'defense in depth' philosophy?", [
        ...
        radioGroup(container, "<strong>8.</strong> What comparison did the hosts make regarding the safety of the US nuclear industry versus fossil fuels?", [
        ...
        radioGroup(container, "<strong>9.</strong> What substance is primarily emitted from the large towers of a nuclear power plant during standard operation?", [
        ...
        radioGroup(container, "<strong>10.</strong> According to the podcast, what is the key reason nuclear energy is described as the 'workhorse' of the energy grid?", [
        ...
        radioGroup(container, "<strong>11.</strong> Which of the following statements was <mark>NOT</mark> made in the podcast regarding the volume of nuclear waste produced?", [
        ...
        radioGroup(container, "<strong>12.</strong> What is the standard two-step process for managing spent fuel once it is removed from a nuclear reactor?", [
        ...
        radioGroup(container, "<strong>13.</strong> What is the primary hurdle preventing the US from following Finland's lead on geological repositories?", [
        ...
        radioGroup(container, "<strong>14.</strong> Which of the following is <mark>NOT</mark> a characteristic of the 'passive safety' systems in modern SMR (Small Modular Reactor) designs?", [
        ...
        radioGroup(container, "<strong>15.</strong> Which of the following is <mark>NOT</mark> a benefit of nuclear fusion that the hosts highlighted while contrasting it with fission?", [
      ...
      fields.recall = [
        radioGroup(container, "<strong>1.</strong> What is the primary physical difference between ionizing and non-ionizing radiation?", [
        ...
        radioGroup(container, "<strong>2.</strong> As stated in the podcast, how does radio frequency (RF) energy cause the biological effect of tissue heating?", [
        ...
        radioGroup(container, "<strong>3.</strong> What physical constraint of RF waves did the hosts highlight regarding immune system interaction?", [
        ...
        radioGroup(container, "<strong>4.</strong> Which of the following was <mark>NOT</mark> a purpose of the $30 million National Toxicology Program (NTP) rodent study?", [
        ...
        radioGroup(container, "<strong>5.</strong> Which of the following was <mark>NOT</mark> a characteristic of the rodent exposure in the NTP study?", [
        ...
        radioGroup(container, "<strong>6.</strong> What crucial detail did the hosts point out when discussing the significance of the NTP study's findings?", [
        ...
        radioGroup(container, "<strong>7.</strong> Which of the following is <mark>NOT</mark> a reason given for why RF energy cannot replicate inside the body?", [
        ...
        radioGroup(container, "<strong>8.</strong> Why does a 10-year-old child absorb up to 153% more radiation than an adult when holding a phone to their head?", [
        ...
        radioGroup(container, "<strong>9.</strong> Which of the following is <mark>NOT</mark> a criticism leveled against current FCC safety guidelines for cellular technology?", [
        ...
        radioGroup(container, "<strong>10.</strong> According to environmental agencies like the Audubon Society, what is the observed impact of cellular networks on birds and bees?", [
        ...
        radioGroup(container, "<strong>11.</strong> Regarding the discussion of the inverse square law, which of the following is <mark>NOT</mark> true?", [
        ...
        radioGroup(container, "<strong>12.</strong> Which of the following is <mark>NOT</mark> a prevalent distance-based safety guideline mentioned in the podcast?", [
        ...
        radioGroup(container, "<strong>13.</strong> As stated in the podcast, what mechanism triggered by weak signals (1-2 bars) makes them problematic for radiation exposure?", [
        ...
        radioGroup(container, "<strong>14.</strong> Which of the following is <mark>NOT</mark> a reason cited for the failure of radiation shield and sticker products?", [
        ...
        radioGroup(container, "<strong>15.</strong> Which of the following was <mark>NOT</mark> considered by the hosts as a cause of power spikes during phone usage in a moving vehicle?", [
      ...
      fields.recall = [
        radioGroup(container, "<strong>1.</strong> How does recombinant DNA technology differ from traditional crossbreeding in its approach to transferring desirable traits?", [
        ...
        radioGroup(container, "<strong>2.</strong> Which of the following was <mark>NOT</mark> part of the genetic solution used to save the Hawaiian papaya?", [
        ...
        radioGroup(container, "<strong>3.</strong> Which of the following is <mark>NOT</mark> a characteristic of the Arctic apple's genetic modification?", [
        ...
        radioGroup(container, "<strong>4.</strong> Why was rice chosen as the target for the nutritional modification that yielded Golden rice?", [
        ...
        radioGroup(container, "<strong>5.</strong> Which popular physiological concern did one of the hosts raise regarding the prominence of GM crops in animal feed?", [
        ...
        radioGroup(container, "<strong>6.</strong> Which of the following does <mark>NOT</mark> happen during the digestion of GM proteins in an animal's body?", [
        ...
        radioGroup(container, "<strong>7.</strong> According to the podcast, what is <mark>NOT</mark> an environmental disadvantage of traditional farmland tilling?", [
        ...
        radioGroup(container, "<strong>8.</strong> The crystalline protein produced by Bt corn (pronounced as 'boot' in the podcast) becomes toxic only when it dissolves in what specific type of environment?", [
        ...
        radioGroup(container, "<strong>9.</strong> Which argument did the hosts present to explain why Bt protein is safe for beneficial insects like ladybugs and bees?", [
        ...
        radioGroup(container, "<strong>10.</strong> What is the primary cause for the emergence of superbugs and superweeds in the environment?", [
        ...
        radioGroup(container, "<strong>11.</strong> Which measurement is <mark>NOT</mark> the focus of a GM crop's substantial equivalence analysis (against its conventional counterpart)?", [
        ...
        radioGroup(container, "<strong>12.</strong> What is <mark>NOT</mark> part of the scientific consensus from global health authorities regarding GMOs and cancer?", [
        ...
        radioGroup(container, "<strong>13.</strong> Why did the hosts argue that the 2012 Seralini rodent study on GM corn and cancer was heavily flawed?", [
        ...
        radioGroup(container, "<strong>14.</strong> What action did researchers take in the 1990s when testing showed that a new GM soybean contained an active allergen from a Brazil nut?", [
        ...
        radioGroup(container, "<strong>15.</strong> According to the podcast, which of the following is <mark>NOT</mark> a driver of the sociological divide and lack of trust in GM foods?", [
    ...
    fields.purpose = textArea(container, "What do you think the purpose of the sound was?");
    ...
    fields.statsRationale = textArea(
      container,
      `While listening to the podcast, you paused ${X} time(s) and backtracked ${Y} time(s) — as far as you can recall, what urged you to occasionally pause/rewind the recording?`
    );
